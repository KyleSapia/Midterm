...
public abstract class Person implements java.io.Serializable {
	...
	public void setDOB(Date DOB) throws PersonException{
		if (this.DOB.getYear() > DOB.getYear() + 100) {
			throw new PersonException("Date is too old", this);
		}
		this.DOB = DOB;
	...
	public void setPhone(String newPhone_number) throws PersonException {
		if(this.phone_number != "^\\(?([0-9]{3})\\)?[-]?([0-9]{3})[-]?([0-9]{4})$") {
			throw new PersonException("Phone number is not valid",this);
		}
